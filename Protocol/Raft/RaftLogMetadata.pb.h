...
#ifndef PROTOBUF_Protocol_2fRaft_2fRaftLogMetadata_2eproto__INCLUDED
#define PROTOBUF_Protocol_2fRaft_2fRaftLogMetadata_2eproto__INCLUDED
...
class Metadata : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_Protocol_2fRaft_2fRaftLogMetadata_2eproto();
  friend void protobuf_AssignDesc_Protocol_2fRaft_2fRaftLogMetadata_2eproto();
  friend void protobuf_ShutdownFile_Protocol_2fRaft_2fRaftLogMetadata_2eproto();
...
inline ::google::protobuf::uint64 Metadata::current_term() const {
  // @@protoc_insertion_point(field_get:LogCabin.Protocol.RaftLogMetadata.Metadata.current_term)
  return current_term_;
}
inline void Metadata::set_current_term(::google::protobuf::uint64 value) {
  set_has_current_term();
  current_term_ = value;
  // @@protoc_insertion_point(field_set:LogCabin.Protocol.RaftLogMetadata.Metadata.current_term)
}
...
inline ::google::protobuf::uint64 Metadata::voted_for() const {
  // @@protoc_insertion_point(field_get:LogCabin.Protocol.RaftLogMetadata.Metadata.voted_for)
  return voted_for_;
}
inline void Metadata::set_voted_for(::google::protobuf::uint64 value) {
  set_has_voted_for();
  voted_for_ = value;
  // @@protoc_insertion_point(field_set:LogCabin.Protocol.RaftLogMetadata.Metadata.voted_for)
}
...
#endif  // PROTOBUF_Protocol_2fRaft_2fRaftLogMetadata_2eproto__INCLUDED
