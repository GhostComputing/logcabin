...
#ifndef PROTOBUF_Protocol_2fTree_2fSnapshot_2eproto__INCLUDED
#define PROTOBUF_Protocol_2fTree_2fSnapshot_2eproto__INCLUDED
...
class Directory : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_Protocol_2fTree_2fSnapshot_2eproto();
  friend void protobuf_AssignDesc_Protocol_2fTree_2fSnapshot_2eproto();
  friend void protobuf_ShutdownFile_Protocol_2fTree_2fSnapshot_2eproto();
...
inline void Directory::add_directories(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:LogCabin.Tree.Snapshot.Directory.directories)
}
inline void Directory::add_directories(const char* value) {
  directories_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:LogCabin.Tree.Snapshot.Directory.directories)
}
inline void Directory::add_directories(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:LogCabin.Tree.Snapshot.Directory.directories)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
Directory::directories() const {
  // @@protoc_insertion_point(field_list:LogCabin.Tree.Snapshot.Directory.directories)
  return directories_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
Directory::mutable_directories() {
  // @@protoc_insertion_point(field_mutable_list:LogCabin.Tree.Snapshot.Directory.directories)
  return &directories_;
}
...
inline const ::std::string& Directory::files(int index) const {
  // @@protoc_insertion_point(field_get:LogCabin.Tree.Snapshot.Directory.files)
  return files_.Get(index);
}
inline ::std::string* Directory::mutable_files(int index) {
  // @@protoc_insertion_point(field_mutable:LogCabin.Tree.Snapshot.Directory.files)
  return files_.Mutable(index);
}
inline void Directory::set_files(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:LogCabin.Tree.Snapshot.Directory.files)
  files_.Mutable(index)->assign(value);
}
inline void Directory::set_files(int index, const char* value) {
  files_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:LogCabin.Tree.Snapshot.Directory.files)
}
inline void Directory::set_files(int index, const char* value, size_t size) {
  files_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:LogCabin.Tree.Snapshot.Directory.files)
}
...
inline void Directory::add_files(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:LogCabin.Tree.Snapshot.Directory.files)
}
inline void Directory::add_files(const char* value) {
  files_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:LogCabin.Tree.Snapshot.Directory.files)
}
inline void Directory::add_files(const char* value, size_t size) {
  files_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:LogCabin.Tree.Snapshot.Directory.files)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
Directory::files() const {
  // @@protoc_insertion_point(field_list:LogCabin.Tree.Snapshot.Directory.files)
  return files_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
Directory::mutable_files() {
  // @@protoc_insertion_point(field_mutable_list:LogCabin.Tree.Snapshot.Directory.files)
  return &files_;
}
...
inline const ::std::string& File::contents() const {
  // @@protoc_insertion_point(field_get:LogCabin.Tree.Snapshot.File.contents)
  return *contents_;
}
inline void File::set_contents(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:LogCabin.Tree.Snapshot.File.contents)
}
inline void File::set_contents(const char* value) {
  ...
  contents_->assign(value);
  // @@protoc_insertion_point(field_set_char:LogCabin.Tree.Snapshot.File.contents)
}
inline void File::set_contents(const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:LogCabin.Tree.Snapshot.File.contents)
}
inline ::std::string* File::mutable_contents() {
  ...
  // @@protoc_insertion_point(field_mutable:LogCabin.Tree.Snapshot.File.contents)
  return contents_;
}
...
inline void File::set_allocated_contents(::std::string* contents) {
  ...
  // @@protoc_insertion_point(field_set_allocated:LogCabin.Tree.Snapshot.File.contents)
}
...
#endif  // PROTOBUF_Protocol_2fTree_2fSnapshot_2eproto__INCLUDED
