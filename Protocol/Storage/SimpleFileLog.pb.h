...
#ifndef PROTOBUF_Protocol_2fStorage_2fSimpleFileLog_2eproto__INCLUDED
#define PROTOBUF_Protocol_2fStorage_2fSimpleFileLog_2eproto__INCLUDED
...
class Metadata : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_Protocol_2fStorage_2fSimpleFileLog_2eproto();
  friend void protobuf_AssignDesc_Protocol_2fStorage_2fSimpleFileLog_2eproto();
  friend void protobuf_ShutdownFile_Protocol_2fStorage_2fSimpleFileLog_2eproto();
...
inline ::google::protobuf::uint64 Metadata::version() const {
  // @@protoc_insertion_point(field_get:LogCabin.Storage.SimpleFileLogMetadata.Metadata.version)
  return version_;
}
inline void Metadata::set_version(::google::protobuf::uint64 value) {
  set_has_version();
  version_ = value;
  // @@protoc_insertion_point(field_set:LogCabin.Storage.SimpleFileLogMetadata.Metadata.version)
}
...
inline const ::LogCabin::Protocol::RaftLogMetadata::Metadata& Metadata::raft_metadata() const {
  // @@protoc_insertion_point(field_get:LogCabin.Storage.SimpleFileLogMetadata.Metadata.raft_metadata)
...
inline ::LogCabin::Protocol::RaftLogMetadata::Metadata* Metadata::mutable_raft_metadata() {
  ...
  // @@protoc_insertion_point(field_mutable:LogCabin.Storage.SimpleFileLogMetadata.Metadata.raft_metadata)
...
inline void Metadata::set_allocated_raft_metadata(::LogCabin::Protocol::RaftLogMetadata::Metadata* raft_metadata) {
  ...
  // @@protoc_insertion_point(field_set_allocated:LogCabin.Storage.SimpleFileLogMetadata.Metadata.raft_metadata)
}
...
inline ::google::protobuf::uint64 Metadata::entries_start() const {
  // @@protoc_insertion_point(field_get:LogCabin.Storage.SimpleFileLogMetadata.Metadata.entries_start)
...
inline void Metadata::set_entries_start(::google::protobuf::uint64 value) {
  ...
  // @@protoc_insertion_point(field_set:LogCabin.Storage.SimpleFileLogMetadata.Metadata.entries_start)
}
...
inline ::google::protobuf::uint64 Metadata::entries_end() const {
  // @@protoc_insertion_point(field_get:LogCabin.Storage.SimpleFileLogMetadata.Metadata.entries_end)
  return entries_end_;
}
inline void Metadata::set_entries_end(::google::protobuf::uint64 value) {
  set_has_entries_end();
  entries_end_ = value;
  // @@protoc_insertion_point(field_set:LogCabin.Storage.SimpleFileLogMetadata.Metadata.entries_end)
}
...
#endif  // PROTOBUF_Protocol_2fStorage_2fSimpleFileLog_2eproto__INCLUDED
