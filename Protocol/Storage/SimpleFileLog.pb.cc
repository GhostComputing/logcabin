...
// source: Protocol/Storage/SimpleFileLog.proto
...
void protobuf_AssignDesc_Protocol_2fStorage_2fSimpleFileLog_2eproto() {
  protobuf_AddDesc_Protocol_2fStorage_2fSimpleFileLog_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "Protocol/Storage/SimpleFileLog.proto");
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_Protocol_2fStorage_2fSimpleFileLog_2eproto);
}
...
void protobuf_ShutdownFile_Protocol_2fStorage_2fSimpleFileLog_2eproto() {
  delete Metadata::default_instance_;
  delete Metadata_reflection_;
}

void protobuf_AddDesc_Protocol_2fStorage_2fSimpleFileLog_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n$Protocol/Storage/SimpleFileLog.proto\022&"
    "LogCabin.Storage.SimpleFileLogMetadata\032#"
    "Protocol/Raft/RaftLogMetadata.proto\"\213\001\n\010"
    "Metadata\022\017\n\007version\030\001 \002(\004\022B\n\rraft_metada"
    "ta\030\002 \002(\0132+.LogCabin.Protocol.RaftLogMeta"
    "data.Metadata\022\025\n\rentries_start\030\003 \002(\004\022\023\n\013"
    "entries_end\030\004 \002(\004", 257);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "Protocol/Storage/SimpleFileLog.proto", &protobuf_RegisterTypes);
  Metadata::default_instance_ = new Metadata();
  Metadata::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_Protocol_2fStorage_2fSimpleFileLog_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_Protocol_2fStorage_2fSimpleFileLog_2eproto {
  StaticDescriptorInitializer_Protocol_2fStorage_2fSimpleFileLog_2eproto() {
    protobuf_AddDesc_Protocol_2fStorage_2fSimpleFileLog_2eproto();
  }
} static_descriptor_initializer_Protocol_2fStorage_2fSimpleFileLog_2eproto_;
...
Metadata::Metadata()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:LogCabin.Storage.SimpleFileLogMetadata.Metadata)
}
...
Metadata::Metadata(const Metadata& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:LogCabin.Storage.SimpleFileLogMetadata.Metadata)
}
...
Metadata::~Metadata() {
  // @@protoc_insertion_point(destructor:LogCabin.Storage.SimpleFileLogMetadata.Metadata)
  SharedDtor();
}
...
const Metadata& Metadata::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_Protocol_2fStorage_2fSimpleFileLog_2eproto();
...
#define ZR_(first, last) do {                              \
  ...
  if (_has_bits_[0 / 32] & 15) {
    ZR_(entries_start_, entries_end_);
    version_ = GOOGLE_ULONGLONG(0);
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:LogCabin.Storage.SimpleFileLogMetadata.Metadata)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:LogCabin.Storage.SimpleFileLogMetadata.Metadata)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:LogCabin.Storage.SimpleFileLogMetadata.Metadata)
  return false;
#undef DO_
}
...
void Metadata::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:LogCabin.Storage.SimpleFileLogMetadata.Metadata)
  // required uint64 version = 1;
  if (has_version()) {
  ...
  // @@protoc_insertion_point(serialize_end:LogCabin.Storage.SimpleFileLogMetadata.Metadata)
}

::google::protobuf::uint8* Metadata::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:LogCabin.Storage.SimpleFileLogMetadata.Metadata)
  // required uint64 version = 1;
  if (has_version()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:LogCabin.Storage.SimpleFileLogMetadata.Metadata)
  return target;
}
