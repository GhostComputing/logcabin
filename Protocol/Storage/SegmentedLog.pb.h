...
#ifndef PROTOBUF_Protocol_2fStorage_2fSegmentedLog_2eproto__INCLUDED
#define PROTOBUF_Protocol_2fStorage_2fSegmentedLog_2eproto__INCLUDED
...
class Metadata : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_format_version() const;
  inline void clear_format_version();
  static const int kFormatVersionFieldNumber = 4;
  inline ::google::protobuf::uint64 format_version() const;
  inline void set_format_version(::google::protobuf::uint64 value);
  ...
  // @@protoc_insertion_point(class_scope:LogCabin.Storage.SegmentedLogMetadata.Metadata)
 private:
  inline void set_has_format_version();
  inline void clear_has_format_version();
  ...
  ::google::protobuf::uint64 format_version_;
  ::google::protobuf::uint64 version_;
  ::LogCabin::Protocol::RaftLogMetadata::Metadata* raft_metadata_;
  ::google::protobuf::uint64 entries_start_;
  friend void  protobuf_AddDesc_Protocol_2fStorage_2fSegmentedLog_2eproto();
  friend void protobuf_AssignDesc_Protocol_2fStorage_2fSegmentedLog_2eproto();
  friend void protobuf_ShutdownFile_Protocol_2fStorage_2fSegmentedLog_2eproto();
...
// required uint64 format_version = 4;
inline bool Metadata::has_format_version() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void Metadata::set_has_format_version() {
  _has_bits_[0] |= 0x00000001u;
}
inline void Metadata::clear_has_format_version() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void Metadata::clear_format_version() {
  format_version_ = GOOGLE_ULONGLONG(0);
  clear_has_format_version();
}
inline ::google::protobuf::uint64 Metadata::format_version() const {
  // @@protoc_insertion_point(field_get:LogCabin.Storage.SegmentedLogMetadata.Metadata.format_version)
  return format_version_;
}
inline void Metadata::set_format_version(::google::protobuf::uint64 value) {
  set_has_format_version();
  format_version_ = value;
  // @@protoc_insertion_point(field_set:LogCabin.Storage.SegmentedLogMetadata.Metadata.format_version)
}
...
inline ::google::protobuf::uint64 Metadata::version() const {
  // @@protoc_insertion_point(field_get:LogCabin.Storage.SegmentedLogMetadata.Metadata.version)
  return version_;
}
inline void Metadata::set_version(::google::protobuf::uint64 value) {
  set_has_version();
  version_ = value;
  // @@protoc_insertion_point(field_set:LogCabin.Storage.SegmentedLogMetadata.Metadata.version)
}
...
inline const ::LogCabin::Protocol::RaftLogMetadata::Metadata& Metadata::raft_metadata() const {
  // @@protoc_insertion_point(field_get:LogCabin.Storage.SegmentedLogMetadata.Metadata.raft_metadata)
...
inline ::LogCabin::Protocol::RaftLogMetadata::Metadata* Metadata::mutable_raft_metadata() {
  ...
  // @@protoc_insertion_point(field_mutable:LogCabin.Storage.SegmentedLogMetadata.Metadata.raft_metadata)
...
inline void Metadata::set_allocated_raft_metadata(::LogCabin::Protocol::RaftLogMetadata::Metadata* raft_metadata) {
  ...
  // @@protoc_insertion_point(field_set_allocated:LogCabin.Storage.SegmentedLogMetadata.Metadata.raft_metadata)
}
...
inline ::google::protobuf::uint64 Metadata::entries_start() const {
  // @@protoc_insertion_point(field_get:LogCabin.Storage.SegmentedLogMetadata.Metadata.entries_start)
...
inline void Metadata::set_entries_start(::google::protobuf::uint64 value) {
  ...
  // @@protoc_insertion_point(field_set:LogCabin.Storage.SegmentedLogMetadata.Metadata.entries_start)
}
...
#endif  // PROTOBUF_Protocol_2fStorage_2fSegmentedLog_2eproto__INCLUDED
