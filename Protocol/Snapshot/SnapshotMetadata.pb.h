...
#ifndef PROTOBUF_Protocol_2fSnapshot_2fSnapshotMetadata_2eproto__INCLUDED
#define PROTOBUF_Protocol_2fSnapshot_2fSnapshotMetadata_2eproto__INCLUDED
...
class Header : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_last_cluster_time() const;
  inline void clear_last_cluster_time();
  static const int kLastClusterTimeFieldNumber = 5;
  inline ::google::protobuf::uint64 last_cluster_time() const;
  inline void set_last_cluster_time(::google::protobuf::uint64 value);
 ...
 private:
  ...
  inline void set_has_last_cluster_time();
  inline void clear_has_last_cluster_time();
  ...
  ::google::protobuf::uint64 last_cluster_time_;
  ::LogCabin::Protocol::Raft::Configuration* configuration_;
  ::google::protobuf::uint64 configuration_index_;
  friend void  protobuf_AddDesc_Protocol_2fSnapshot_2fSnapshotMetadata_2eproto();
  friend void protobuf_AssignDesc_Protocol_2fSnapshot_2fSnapshotMetadata_2eproto();
  friend void protobuf_ShutdownFile_Protocol_2fSnapshot_2fSnapshotMetadata_2eproto();
...
inline ::google::protobuf::uint64 Header::last_included_index() const {
  // @@protoc_insertion_point(field_get:LogCabin.Server.SnapshotMetadata.Header.last_included_index)
...
inline void Header::set_last_included_index(::google::protobuf::uint64 value) {
  ...
  // @@protoc_insertion_point(field_set:LogCabin.Server.SnapshotMetadata.Header.last_included_index)
}
...
inline ::google::protobuf::uint64 Header::last_included_term() const {
  // @@protoc_insertion_point(field_get:LogCabin.Server.SnapshotMetadata.Header.last_included_term)
...
inline void Header::set_last_included_term(::google::protobuf::uint64 value) {
  ...
  // @@protoc_insertion_point(field_set:LogCabin.Server.SnapshotMetadata.Header.last_included_term)
}

// optional uint64 last_cluster_time = 5;
inline bool Header::has_last_cluster_time() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void Header::set_has_last_cluster_time() {
  _has_bits_[0] |= 0x00000004u;
}
inline void Header::clear_has_last_cluster_time() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void Header::clear_last_cluster_time() {
  last_cluster_time_ = GOOGLE_ULONGLONG(0);
  clear_has_last_cluster_time();
}
inline ::google::protobuf::uint64 Header::last_cluster_time() const {
  // @@protoc_insertion_point(field_get:LogCabin.Server.SnapshotMetadata.Header.last_cluster_time)
  return last_cluster_time_;
}
inline void Header::set_last_cluster_time(::google::protobuf::uint64 value) {
  set_has_last_cluster_time();
  last_cluster_time_ = value;
  // @@protoc_insertion_point(field_set:LogCabin.Server.SnapshotMetadata.Header.last_cluster_time)
}
...
inline const ::LogCabin::Protocol::Raft::Configuration& Header::configuration() const {
  // @@protoc_insertion_point(field_get:LogCabin.Server.SnapshotMetadata.Header.configuration)
...
inline ::LogCabin::Protocol::Raft::Configuration* Header::mutable_configuration() {
  ...
  // @@protoc_insertion_point(field_mutable:LogCabin.Server.SnapshotMetadata.Header.configuration)
...
inline void Header::set_allocated_configuration(::LogCabin::Protocol::Raft::Configuration* configuration) {
  ...
  // @@protoc_insertion_point(field_set_allocated:LogCabin.Server.SnapshotMetadata.Header.configuration)
}
...
inline ::google::protobuf::uint64 Header::configuration_index() const {
  // @@protoc_insertion_point(field_get:LogCabin.Server.SnapshotMetadata.Header.configuration_index)
...
inline void Header::set_configuration_index(::google::protobuf::uint64 value) {
  ...
  // @@protoc_insertion_point(field_set:LogCabin.Server.SnapshotMetadata.Header.configuration_index)
}
...
#endif  // PROTOBUF_Protocol_2fSnapshot_2fSnapshotMetadata_2eproto__INCLUDED
